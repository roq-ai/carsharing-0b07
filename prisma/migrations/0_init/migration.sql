...
-- AddForeignKey
ALTER TABLE "performance" ADD CONSTRAINT "performance_vehicle_id_fkey" FOREIGN KEY ("vehicle_id") REFERENCES "vehicle"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
