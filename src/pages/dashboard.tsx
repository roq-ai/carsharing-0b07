...
function DashboardPage() {
  ...
  const performanceStat = useSWR<PaginatedInterface<PerformanceInterface>>(
    () => `/performances`,
    () => getPerformances({ limit: 1, offset: 0 }),
  );
  ...
  const statResults = [
    ...
    {
      title: 'Performances',
      result: performanceStat?.data?.totalCount,
      isLoading: performanceStat.isLoading,
    },
    {
      title: 'Vehicles',
          ...
          <Stack direction="column" spacing={8} flex={{ base: 1, md: 7 }}>
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                ...
                <NextLink href={`usages`} passHref legacyBehavior>
                  <Button
